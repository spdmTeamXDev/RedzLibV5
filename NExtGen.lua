...
function redzlib:MakeWindow(Configs)
  ...
  -- Inicia a animação em uma nova thread para não bloquear outras operações
  ...
  function Window:MakeTab(paste, Configs)
    ...
    function Tab:AddSlider(Configs)
      ...
      function Slider:SettValue(v)
        SetSlider(tonumber(v))
      end
      function Slider:Destroy()
        Button:Destroy()
      end
      function Slider:MaxName(e)
        Max = e
      end
      function Slider:MaxSet(e)
        Max = e
      end
      function Slider:MinSet(e)
        Min = e
      end
      function Slider:IncreaseSet(e)
        Increase = e
      end
      ...
      return TextBox
		...
		function Tab:AddDiscordInvite(Configs)
			...
			local InviteLabel = Create("TextLabel", InviteHolder, {
				...
				Position = UDim2.new(0, 5),
				TextColor3 = Color3.fromRGB(50, 250, 40),
				Font = Enum.Font.FredokaOne,
				TextXAlignment = "Left",
				BackgroundTransparency = 1,
				TextSize = 10,
				Text = "استمتع... سيرفير تليگرام يمكنك دخول"
			})
